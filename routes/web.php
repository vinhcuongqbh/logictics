...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'donhang'], function () {
        ...
        Route::get('dmdatao', [DonhangController::class, 'dmdatao'])->name('donhang.dmdatao');
        ...
        Route::post('themdonhang', [DonhangController::class, 'themdonhang'])->name('donhang.themdonhang');
        ...
        Route::post('hoanlainhapkho', [DonhangController::class, 'hoanlainhapkho'])->name('donhang.hoanlainhapkho');
        Route::get('{id}/hoanlaixuatkho', [DonhangController::class, 'hoanlaixuatkho'])->name('donhang.hoanlaixuatkho');
    ...
    Route::group(['prefix' => 'thongke'], function () {
        Route::get('thongketonghop', [ThongketonghopController::class, 'ketQuaThongKe'])->name('thongke.ketquathongke');
