                    ...
                    <div class="row">
                        <div class="col-sm-12">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group row">
                                                <label for="mathang" class="col-sm-3 col-form-label">Mặt
                                                    hàng</label>
                                                <div class="col-sm-9">
                                                    <input type="text" id="mathang" name="mathang" list="danhmucmathang"
                                                        class="form-control">
                                ...
                                <table id="donhang-table" class="table table-bordered table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $chitietdonhang->khoiluong}}</td>
                                            <td>{{ $chitietdonhang->kichthuoc}}</td>
                                            <td>{{ $chitietdonhang->chiphi}}</td>
                                        </tr>
                                        @endforeach                                       
                                    </tbody>
                                    <tfoot>
                            ...
                            <div class="form-group" style="margin-top: 20px;">
                                <div class="col-12">
                                    <a href="{{ route.create }}"><button type="button" value="TẠO MỚI" class="btn btn-primary float-right">TẠO MỚI</button></a>
                                    <a href="{{ route.edit }}"><button type="button" value="SỬA" class="btn btn-secondary float-right">SỬA</button></a>
                                    <a href="{{ route.delete }}"><button type="button" value="XÓA" class="btn btn-secondary float-right">XÓA</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
