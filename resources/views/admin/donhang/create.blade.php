                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group" style="margin-top: 20px;">
                                        <div class="col-12">
                                            <input type="submit" id="submitForm" value="TẠO MỚI" class="btn btn-primary float-right">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            var tinhChiPhiEdit = function() {
                ...
                if (soluong != 0 && khoiluong == "") {
                    ...
                    let chiphi = soluong * parseInt(dongiatinhtheosoluong.find(e => e.tenmathang ==
                            tenmathang)?.dongia ||
                        0);
                    document.querySelector("#chiphiEdit").value = chiphi;
                }
            ...
            const tongchiphi = function() {
                document.querySelector("#tongchiphi").innerHTML = Intl.NumberFormat('vi-VN', {
                    style: 'currency',
                    currency: 'VND'
                }).format(donhangTable.column(6).data().sum());
            }
