                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select id="id_loainhanvien" name="id_loainhanvien" class="form-control custom-select">
                                ...
                                <option value="{{ $loainhanvien->id }}" @if ($loainhanvien->id ==
                                    $nhanvien->id_loainhanvien) {{ 'selected' }}
                                    @endif>{{ $loainhanvien->tenloainhanvien }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <select class="custom-select" id="id_khohangquanly" name="id_khohangquanly">
                                    ...
                                    <option value="{{ $khohang->id }}" @if ($nhanvien->id_khohangquanly == $khohang->id)
                                        {{ 'selected' }} @endif>
