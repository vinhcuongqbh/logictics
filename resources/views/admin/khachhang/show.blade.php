                        ...
                        <div class="form-group">
                            <div class="col-12">
                                @if ($khachhang->id_trangthai == 1)
                                    <a href="{{ route('khachhang.delete', $khachhang->id) }}" onclick="return confirm('Bạn muốn xóa Khách hàng này?')"><button type="button"
                                            class="btn btn-danger float-right"
                                            style="width: 100px; margin: 5px;">XÓA</button></a>
                                @else
                                    <a href="{{ route('khachhang.restore', $khachhang->id) }}" onclick="return confirm('Bạn muốn phục hồi Khách hàng này?')"><button type="button"
